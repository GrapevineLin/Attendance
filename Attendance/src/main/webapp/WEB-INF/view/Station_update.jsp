...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" id="objForm" action="Station"
              method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="jobCat" name="jobCat" required="" lay-verify="jobCat"
                           autocomplete="off" class="layui-input" value="${jobCat}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div style="margin-left:110px;top:-5px;padding:0">
                    <textarea id="jobDes" name="jobDes" rows="4" cols="4" class="layui-textarea"
                              value="${jobDes}">${jobDes}</textarea>
                </div>
            </div>
