                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="Classes">
                            ...
                            <table id="datalist" class="layui-table layui-form">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="item" items="${DataList}">
                                        <tr>
                                            <td>
                                                <input type="checkbox" value="${item.classId}" name="" lay-skin="primary"/>
                                            </td>
                                            <td>${item.classId}</td>
...
<%--                            </div>--%>
    ...
    <script>
      ...
      function delAll (argument) {
          ...
          //
          // // 获取选中的id
          // $('#datalist input[type=checkbox]:checked').each(function(index, el) {
